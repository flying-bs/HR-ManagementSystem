...
public class EmpDAO extends HibernateDaoSupport {
	...
	public List<Emp> findByExample(Emp instance) {
		...
		try {
			List<Emp> results = getHibernateTemplate()
	...
	public List<Emp> findByEname(Object ename) {
		return findByProperty(ENAME, ename);
	}

	public List<Emp> findBySex(Object sex) {
	...
	public List<Emp> findByPhoto(Object photo) {
	...
	public Emp merge(Emp detachedInstance) {
		...
		try {
			Emp result = getHibernateTemplate().merge(detachedInstance);
