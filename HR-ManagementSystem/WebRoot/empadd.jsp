...
<form action="save_Emp.action" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="500" border="1" align="center" cellpadding="1" cellspacing="0">
    <tr>
      <td colspan="3" align="center" bgcolor="#CCFFCC">员工添加</td>
    </tr>
    <tr>
      <td width="51">姓名</td>
      <td width="344"><s:textfield name="emp.ename"/></td>
      <td width="91" rowspan="7" align="left" valign="top"><img src="uppic/default.jpg" width="91" height="160" alt="" /></td>
    </tr>
    <tr>
      <td>性别</td>
    ...
    <tr>
      <td>生日</td>
      <td><input type="date" name="emp.sdate" value="1980-01-01"/></td>
    </tr>
    <tr>
      <td>照片</td>
